...
class vLLMHttpServer:
    ...
    async def generate(
        ...
        elif requested_logprobs is False or requested_logprobs is None:
            sampling_params["logprobs"] = None
        else:
            # Preserve explicit integer requests such as -1 (all vocabulary
            # logprobs) used by full-vocabulary OPD scoring.
